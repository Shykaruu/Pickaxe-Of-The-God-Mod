...
public class PickaxeOfTheGodLevel13Item extends PickaxeofthegodModElements.ModElement {
	@ObjectHolder("pickaxeofthegod:pickaxe_of_the_god_level_13")
	public static final Item block = null;

	public PickaxeOfTheGodLevel13Item(PickaxeofthegodModElements instance) {
		super(instance, 17);
	}
