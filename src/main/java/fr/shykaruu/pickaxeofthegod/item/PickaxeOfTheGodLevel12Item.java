...
public class PickaxeOfTheGodLevel12Item extends PickaxeofthegodModElements.ModElement {
	@ObjectHolder("pickaxeofthegod:pickaxe_of_the_god_level_12")
	public static final Item block = null;

	public PickaxeOfTheGodLevel12Item(PickaxeofthegodModElements instance) {
		super(instance, 16);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("pickaxe_of_the_god_level_12"));
	}
	...
	private static class ItemToolCustom extends Item {
		...
		public boolean canHarvestBlock(BlockState state) {
			return 12 >= state.getHarvestLevel();
		}
