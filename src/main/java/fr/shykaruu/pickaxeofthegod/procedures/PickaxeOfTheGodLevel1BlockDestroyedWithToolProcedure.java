...
public class PickaxeOfTheGodLevel1BlockDestroyedWithToolProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				PickaxeofthegodMod.LOGGER.warn("Failed to load dependency world for procedure PickaxeOfTheGodLevel1BlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				PickaxeofthegodMod.LOGGER.warn("Failed to load dependency x for procedure PickaxeOfTheGodLevel1BlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				PickaxeofthegodMod.LOGGER.warn("Failed to load dependency y for procedure PickaxeOfTheGodLevel1BlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				PickaxeofthegodMod.LOGGER.warn("Failed to load dependency z for procedure PickaxeOfTheGodLevel1BlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				PickaxeofthegodMod.LOGGER.warn("Failed to load dependency entity for procedure PickaxeOfTheGodLevel1BlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				PickaxeofthegodMod.LOGGER.warn("Failed to load dependency itemstack for procedure PickaxeOfTheGodLevel1BlockDestroyedWithTool!");
			return;
		}
