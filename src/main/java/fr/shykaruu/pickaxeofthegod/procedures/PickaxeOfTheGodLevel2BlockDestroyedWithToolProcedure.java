...
import fr.shykaruu.pickaxeofthegod.item.PickaxeOfTheGodLevel3Item;
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				PickaxeofthegodMod.LOGGER.warn("Failed to load dependency world for procedure PickaxeOfTheGodLevel2BlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				PickaxeofthegodMod.LOGGER.warn("Failed to load dependency x for procedure PickaxeOfTheGodLevel2BlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				PickaxeofthegodMod.LOGGER.warn("Failed to load dependency y for procedure PickaxeOfTheGodLevel2BlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				PickaxeofthegodMod.LOGGER.warn("Failed to load dependency z for procedure PickaxeOfTheGodLevel2BlockDestroyedWithTool!");
			return;
		}
		...
		if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
			((PlayerEntity) entity).sendStatusMessage(new StringTextComponent(
					("\u00A72" + (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
							.getOrCreateTag().getDouble("PickaxeOfTheGodLevelXp")) + "\u00A7c/500 xp.")),
					(true));
		}
		if (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY).getOrCreateTag()
				.getDouble("PickaxeOfTheGodLevelXp") >= 500) {
			itemstack.getOrCreateTag().putDouble("PickaxeOfTheGodLevelXp", 0);
			if (entity instanceof LivingEntity) {
				ItemStack _setstack = new ItemStack(PickaxeOfTheGodLevel3Item.block);
